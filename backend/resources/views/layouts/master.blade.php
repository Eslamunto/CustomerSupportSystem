            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown notifications-menu">
                        @if (Auth::user()->role == 0)
                            <a href="{{ route('showNotifications', ['role' => 'admin', 'id' => Auth::user()->id]) }}"
                               class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                @elseif(Auth::user()->role == 1)
                                    <a href="{{ route('showNotifications', ['role' => 'supervisor', 'id' => Auth::user()->id]) }}"
                                       class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                        @elseif(Auth::user()->role == 2)
                                            <a href="{{ route('showNotifications', ['role' => 'agent', 'id' => Auth::user()->id]) }}"
                                               class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                                                @endif
                                            ...
                                            <ul class="dropdown-menu menu-scroll" style="width:500px;">
                                                <li class="header">You have {{ $notifications_count }} new
                                                    notifications
                                                </li>
                                                <li>
                                                    <ul class="menu"
                                                                ...
                                                                <a href="#">
                                                                    <h5>
                                                                        ...
                                                                        @if($notification->is_read == 0)
                                                                            <span class="label bg-yellow pull-right"
                                                                                  style="border-radius: 10px; width: 0px; height: 13px;">&nbsp</span>
                                                                        @endif
                                                                    </h5>
                                                                    {{ $notification->body }}
                                                                </a>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                @if(Auth::user()->role == 0)
                    ...
                    <li class="active"><a href="{{ Route('adminFeed') }}"><i class="fa fa-rss"></i>
                            <span>Feed</span></a></li>
                    <li class="treeview">
                    ...
                    <li><a href="{{route('createCustomerAdmin')}}"><i class="fa fa-group"></i>
                            <span>Customers</span></a></li>
                    {{-- <li><a href="#"><i class="fa fa-ticket"></i> <span>Tickets</span></a></li> --}}
                    <li><a href="{{ URL::route('admin.department.index') }}"><i class="fa fa-puzzle-piece"></i> <span>Departments</span></a>
                    </li>
                ...
                @elseif (Auth::user()->role == 1)
                        ...
                        <!-- Optionally, you can add icons to the links -->
                        <li class="active"><a href="{{ Route('supervisorFeed') }}"><i class="fa fa-feed"></i>
                                <span>Feed</span></a></li>
                        {{-- <li class="treeview">
                          <a href="#"><i class="fa fa-optin-monster"></i> <span>Team Activity</span> <i class="fa fa-angle-left pull-right"></i></a> --}}
                        {{-- <ul class="treeview-menu"> --}}
                        <li><a href="{{ route('supervisorTeamAgents', Auth::user()->id) }}"><i class="fa fa-user"></i>
                                <span>Support Agents Activity</span></a></li>
                        {{-- <li><a href="#"><i class="fa fa-ticket"></i> <span>Tickets History</span></a></li> --}}
                        {{-- </ul> --}}
                        {{-- </li> --}}
                        <li><a href="{{route('createCustomerSupervisor')}}"><i class="fa fa-group"></i>
                                <span>Customers</span></a></li>
                        @else
                            <li class="header"> SUPPORT AGENT</li>
                            <!-- Optionally, you can add icons to the links -->
                            <li class="active">
                                <a href="{{ Route('agentFeed') }}"><i class="fa fa-ticket"></i>
                                    <span>Tickets Feed</span></a>
                            </li>
                            {{-- <li>
                              <a href="#"><i class="fa fa-history"></i> <span>Tickets History</span></a>
                            </li> --}}
                            <li>
                                <a href="{{route('createCustomerAgent')}}"><i class="fa fa-group"></i>
                                    <span>Cutomers</span></a>
                            </li>
                        @endif
                        ...
                        @else
                            <li>
                                <button id="twitterButton" data-link="{{ Route('twitterAuthentication') }}"
                                        class="twitter-conn-btn btn btn-sm btn-info">
                        ...
                        <li>
                            <div>
                                <form method="POST" action="{{ Route('sendDM') }}" role="form">
                                    <input placeholder="Twitter Username" type="text" name="twitterHandle"
                                           style="display: block;margin-top: 20px;margin-left: 35px;">
                                    <input type="number" placeholder="Ticket ID" name="ticketId"
                                           style="display: block;margin-top: 2px;margin-left: 35px;">
                                    <button class="btn btn-danger" name="submit" value="submit"
                                            style="display: block;margin-top: 2px; margin-left: 32px;">Send DM to
                                        Customer
                                    </button>
                                </form>
                            </div>
